...
if __name__ == "__main__":
    ...
    scad_render_to_file(platformbed.base_side(length), filepath="scadfiles/base_side.scad")
    scad_render_to_file(platformbed.base_support(length, overhang), filepath="scadfiles/base_support.scad")
    scad_render_to_file(platformbed.base_end(width), filepath="scadfiles/base_end.scad")
